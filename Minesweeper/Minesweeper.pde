...
void draw(){
    ...
    fill(240,240,240);
    text("Verbleibende Minen: " + uebrigeMinen,417,26);
    ...
    if (x != -1){
        ...
        for (int i = 0; i < Breite; i++){
         ...
         //VERLIERERBILDSCHIRM
        fill(150,20,150);
        text("Zum Neustarten      TAB      druecken",85,26);
        fill(240,0,0);
        text("VERLOREN!",460,200);}
